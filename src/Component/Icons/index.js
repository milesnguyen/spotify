export const LeftIcon = ({
  ...
  <svg height={height} width={width} className={className} viewBox="0 0 24 24">
...
export const RandomIcon = ({
  ...
  <svg height={height} width={width} className={className} viewBox="0 0 16 16">
    <path
